...
#[ApiResource(
    operations: [
        ...
        new Patch(processor: UserPasswordHasher::class, security: "is_granted( 'IS_AUTHENTICATED_FULLY') and object == user "),
        new Delete(security: "is_granted( 'IS_AUTHENTICATED_FULLY') and object == user" or "is_granted('ROLE_ADMIN')" ),
    ],
