...
#[ApiResource(
    operations: [
        ...
        new Get(security: "is_granted('POST_VIEW')"),
        new Put(security: "is_granted( ['POST_WRITE','IS_AUTHENTICATED_FULLY'] )"),
        new Patch(security: "is_granted('POST_WRITE')"),
        new Delete(security: "is_granted('POST_WRITE')"),
    ],
